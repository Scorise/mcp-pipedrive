...
import { UpdateOrganizationFieldSchema } from '../../schemas/organization-field.js';
import type { PipedriveResponse } from '../../types/common.js';

export function getUpdateOrganizationFieldTool(client: PipedriveClient) {
  return {
...
- Toggle the field's visibility in the add form`,
      inputSchema: {
        ...
        properties: {
          id: {
            type: 'number',
            description: 'ID of the organization field to update',
          },
          name: {
            type: 'string',
      ...
      handler: async (args: unknown) => {
        const parsed = UpdateOrganizationFieldSchema.parse(args);
